...
def makeGraph(yamlData, output, show_orphans=True, verbose=0):
        ...
        for package in yamlData["remotes"]:
            ...
            for message in yamlData["remotes"][package]:
                ...
                if message == salCpt:
                    ...
                    # just show nodes connected to requiredCsc if it's set
...
# Do the work
#
makeGraph(yamlData, output=args.output, show_orphans=args.show_orphans, verbose=args.verbose)
