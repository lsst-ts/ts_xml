...
file.write("\tfile = open(dir_path + '/../sal_interfaces/SALGenerics.xml')\n")
...
for csc in xml_common.subsystems:
	...
	if events_file:
		...
		file.write("\t\tself.csc_tree = ET.parse(self.dir_path + \"/../sal_interfaces/" + csc + "/" + csc + "_Events.xml\")\n")
	...
	if commands_file:
		...
		file.write("\t\tself.csc_tree = ET.parse(self.dir_path + \"/../sal_interfaces/" + csc + "/" + csc + "_Commands.xml\")\n")
		file.write("\t\tfor alias in self.csc_tree.findall('./SALEvent/Alias'):\n")
