...
subsystems = [
    ...
    'ATWhiteLight', 'CatchupArchiver', 'CBP', 'DIMM', 'Dome', 'DSM', 'EAS',
    ...
    'MTVMS', 'OCS', 'PointingComponent', 'PromptProcessing', 'Rotator',
...
db_reserved = [
    ...
    'CALL', 'CASCADE', 'CASE', 'CATALOG_NAME', 'CHANGE', 'CHAR', 'CHARACTER',
    ...
    'DECLARE', 'DEFAULT', 'DELAYED', 'DELAY_KEY_WRITE', 'DELETE', 'DESC',
    ...
    'HOUR_SECOND', 'IF', 'IGNORE', 'IN', 'INDEX', 'INFILE', 'INITIAL_SIZE',
    'INNER', 'INOUT', 'INSENSITIVE', 'INSERT', 'INSERT_METHOD', 'INT', 'INT1',
    'INT2', 'INT3', 'INT4', 'INT8', 'INTEGER', 'INTERVAL', 'INTO',
    'IO_AFTER_GTIDS', 'IO_BEFORE_GTIDS', 'IS', 'ITERATE', 'JOIN', 'KEY',
    'KEYS', 'KEY_BLOCK_SIZE', 'KILL', 'LEADING', 'LEAVE', 'LEAVES', 'LEFT',
    ...
    'REPEATABLE', 'REPLACE', 'REQUIRE', 'RESIGNAL', 'RESTRICT', 'RETURN',
