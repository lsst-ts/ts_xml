...
Below are the descriptions and content recommendations for SALCommandSet.xml
attributes.

SALCommandSet
=============

**Data Type**: commandSetType

This is a complex type for an abritrary set of SALCommand definitions
...
This the complex type for the definition of a partcular command. 
...
**Data Type**: commandItemType

This is an optional element which may be used an arbitrary number 
of times to add data items to a command definition.
...
This is a brief description of the purpose of the command. 
...
This is a complex type for an SALCommand definition with an 
...
This is used to specify which subsystem the command is associated
with.
...
store the historical record for this command. It is also used for the 
...
or if it appears outside of the <CommandSet>, it applies globally.
